...
/**
 * stats/index.js
 * Minimal Azure Function that counts stored analysis metadata to surface total
 * recognitions for dashboards and telemetry.
 */
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    try {
      ...
      // Iterate blobs lazily to avoid materialising large result sets.
