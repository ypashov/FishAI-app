...
/**
 * Azure Function: Accepts a base64 encoded image payload, writes it to Blob Storage,
 * calls Azure AI Vision for analysis, and returns the structured result plus a
 * time-limited SAS URL so the client can show the stored image.
 */
